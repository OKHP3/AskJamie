...
# These GPTs remain in the AskJamie catalog, but are currently private in the
# owner's library and are not yet public destinations.
IN_DEVELOPMENT_GPTS = {
...
def main() -> int:
    ...
    for lens_id, url in IN_DEVELOPMENT_GPTS.items():
        print(f"{lens_id}: in-development: url={url}")
    exit_code = 0
