#!/usr/bin/env node
/**
 * Run the same desktop Lighthouse pass against the four public routes and
 * compare the compact results with the committed 2026-08-22 baseline.
 *
...
const outputDir = resolve(root, "assets/audit", `lighthouse-${date}`);
const routes = {
  homepage: "/",
...
const summary = {
  ...
  environment: "Local or supplied static server, desktop preset",
  property: baseUrl,
